dotnet publish -c Release --self-contained true /p:PublishSingleFile=true /p:PublishAot=true  ..\CBTEditor\CBTEditor\ -r win-x64 -o .\publish
ISCC.exe "CBT Editor Installer Script.iss"
